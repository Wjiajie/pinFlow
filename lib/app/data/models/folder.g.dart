...
const FolderSchema = CollectionSchema(
  ...
  links: {
    r'space': LinkSchema(
      id: -3929638851056851067,
      name: r'space',
      target: r'Space',
      single: true,
    ),
    r'notes': LinkSchema(
      id: 908575155049513515,
      name: r'notes',
      target: r'NoteDocument',
      single: false,
      linkName: r'folder',
    )
  },
...
List<IsarLinkBase<dynamic>> _folderGetLinks(Folder object) {
  return [object.space, object.notes];
}

void _folderAttach(IsarCollection<dynamic> col, Id id, Folder object) {
  object.id = id;
  object.space.attach(col, col.isar.collection<Space>(), r'space', id);
  object.notes.attach(col, col.isar.collection<NoteDocument>(), r'notes', id);
}
...
extension FolderQueryLinks on QueryBuilder<Folder, Folder, QFilterCondition> {
  QueryBuilder<Folder, Folder, QAfterFilterCondition> space(
      FilterQuery<Space> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'space');
    });
  }

  QueryBuilder<Folder, Folder, QAfterFilterCondition> spaceIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'space', 0, true, 0, true);
    });
  }

  QueryBuilder<Folder, Folder, QAfterFilterCondition> notes(
      FilterQuery<NoteDocument> q) {
    return QueryBuilder.apply(this, (query) {
